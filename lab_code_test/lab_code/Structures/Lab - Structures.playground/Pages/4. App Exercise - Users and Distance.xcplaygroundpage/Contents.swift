...
var yourName = User(username: "KangTW", age: 24, height: 170, weight: 70, activityLevel: 1)
print("name: \(yourName.username), age: \(yourName.age), height: \(yourName.height) cm. weight:\(yourName.weight) kg. activity level: \(yourName.activityLevel)")
